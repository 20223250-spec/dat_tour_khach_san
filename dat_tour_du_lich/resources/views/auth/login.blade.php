...
@section('hero')
    <div class="hero-panel p-4 p-lg-5">
        <div class="row align-items-center g-4">
            <div class="col-lg-7">
                <span class="badge badge-soft mb-3 px-3 py-2">Khu vực thành viên</span>
                <h1 class="display-6 fw-bold mb-3">Đăng nhập để theo dõi đơn đặt và thông báo.</h1>
                <p class="lead text-white-50 mb-0">Sau khi đăng nhập, bạn có thể sử dụng đầy đủ tính năng ngay lập tức.</p>
            </div>
            <div class="col-lg-5">
