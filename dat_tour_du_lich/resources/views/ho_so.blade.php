        ...
        <div class="row align-items-center g-4">
            <div class="col-lg-8">
                ...
                <div class="d-flex flex-wrap gap-3">
                    ...
                    <span class="badge bg-light text-primary px-3 py-2">{{ auth()->user()->roleLabel() }}</span>
            ...
            <div class="col-lg-4">
                <div class="surface-card p-4">
                    ...
                    <p class="mb-0 text-success fw-semibold">
                        <i class="fa-solid fa-circle-check me-2"></i>Tài khoản đã sẵn sàng sử dụng.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4">
            ...
            <div class="surface-card p-4 h-100">
                ...
                <div class="d-grid gap-3">
                    <div class="border rounded-4 p-3">
                        <div class="text-primary fw-semibold mb-1">Loại tài khoản</div>
                        <div>{{ auth()->user()->roleLabel() }}</div>
                    </div>
                    <div class="border rounded-4 p-3">
        ...
        <div class="col-lg-8">
            <div class="surface-card p-4 p-lg-5">
                <div class="mb-4">
                    <h2 class="section-title h3 mb-0">Cập nhật hồ sơ</h2>
                </div>
                ...
                <form method="POST" action="{{ route('profile.update') }}" class="row g-4">
                    ...
                    <div class="col-12">
                        <label class="form-label fw-semibold">Vai trò hiện tại</label>
                        <input type="text" class="form-control" value="{{ auth()->user()->roleLabel() }}" disabled>
                    </div>
