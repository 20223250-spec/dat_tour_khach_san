...
@section('hero')
    <div class="hero-panel p-4 p-lg-5">
        <div class="row g-4 align-items-center">
            <div class="col-lg-6">
                @if ($tour->image_url)
                    <img src="{{ $tour->image_url }}" alt="{{ $tour->name }}" class="tour-cover">
                @else
            ...
            <div class="col-lg-6">
                ...
                <div class="d-flex flex-wrap gap-4 text-white-50 mb-4">
                    ...
                    <span><i class="fa-regular fa-user me-2"></i>{{ $tour->owner?->name ?? 'Hệ thống' }}</span>
                </div>
        ...
        <div class="col-lg-8">
            <section class="surface-card p-4 p-lg-5 mb-4">
                <div class="d-flex justify-content-between align-items-start gap-3 mb-4">
                    <div>
                        <h2 class="section-title h3 mb-0">Thông tin tour</h2>
                    </div>
            ...
            <section class="surface-card p-4 p-lg-5">
                <div class="d-flex justify-content-between align-items-start gap-3 mb-4">
                    <div>
                        <h2 class="section-title h3 mb-0">Đánh giá khách hàng</h2>
                    </div>
                    @if($averageRating)
                ...
                <section class="surface-card p-4 mb-4">
                    ...
                    <form method="POST" action="{{ route('bookings.store', $tour->id) }}" class="d-grid gap-3">
                        ...
                        <div>
                            ...
                            <input id="number_of_people" type="number" class="form-control" name="number_of_people" min="1" max="{{ $tour->available_seats }}" value="{{ old('number_of_people', 1) }}" required>
                        </div>
